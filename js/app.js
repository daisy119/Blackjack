...
function render(cardPicked) {
  ...
  // if (playerHand.length === 1) {  
  //   p2El.classList.remove("outline")
  // }
  // if (playerHand.length > 1) {  
  //   p2El.classList.remove(cardToRemove)
  // }
  // cardToRemove = cardPicked  

  // p1El.classList.add()
  // if (deck1.length === 26) {  
  //   p2El.classList.add("shadow");
    // p1El.classList.remove("shadow");
  // }
  // if (deck1.length === 0) {  
  //   p1El.classList.add("outline");
  //   p1El.classList.remove("back-blue");
  // }
}
